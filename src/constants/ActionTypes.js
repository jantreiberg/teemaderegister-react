...
export const USER_SETTINGS_SAVE_ERROR = 'USER_SETTING_SAVE_ERROR'
...
export const USER_PICTURE_RESET_START = 'USER_PICTURE_RESET_START'
export const USER_PICTURE_RESET_END = 'USER_PICTURE_RESET_END'
export const USER_PICTURE_RESET_ERROR = 'USER_PICTUER_RESET_ERROR'

// password settings
export const PASSWORD_SETTINGS_LOADED = 'PASSWORD_SETTINGS_LOADED'
