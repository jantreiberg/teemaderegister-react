...
export const USER_PROFILE_URL = `${API}/users/:id`
export const USER_UPDATE_URL = `${API}/users/:id`
export const USER_UPDATE_PASSWORD_URL = `${API}/users/:id/password`
export const USER_PICTURE_UPLOAD_URL = `${API}/users/:id/upload-picture`
export const USER_PICTURE_RESET_URL = `${API}/users/:id/reset-picture`
